...
const { userTasks, createNewTask, newTask } = userCrm();
...
<template>
  <q-form class="new-task__container" @submit="createNewTask">
    <div class="new-task__title">Новая задача</div>
    <div class="new-task__name">
    ...
    <div class="new-task__specifications-container">
      <div class="new-task__specifications-head">
        <div>
      ...
      <div class="new-task__specifications-words">
        <div
          class="new-task__specifications-word"
          v-for="word in words"
          :key="word"
        >
          {{ word }}
    ...
    <div class="new-task__load-docs">
      <div class="new-task__load-docs--header">
        <div>Загрузить не более 5 документов</div>
        <q-btn color="primary" label="загрузить документы" />
      </div>
      <div class="new-task__load-docs--list">
        <div class="new-task__load-docs--doc" v-for="item in 5">
